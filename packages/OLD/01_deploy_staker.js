...
module.exports = async ({ getNamedAccounts, deployments, getChainId }) => {
  ...
  const exampleExternalContract2 = await ethers.getContract(
    "ExampleExternalContract",
    deployer
  );

  //await exampleExternalContract.setStakerContractAddress("0x67Ac51940920f10aFbdb58F42B53Fd3aB90AD0f9");
  //await exampleExternalContract.setStakerContractAddress(stakerContract.address);
